...
useEffect(() => {
  ...
  // ============================================
  // RENDER (same as your provided UI)
  // ============================================
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl font-bold">DutyDesk - Admin</h1>
              </div>
...
>
  ...
  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-semibold transition ${
    adminView === 'auto-assign' ? 'bg-white text-indigo-600' : 'bg-indigo-700 hover:bg-indigo-800'
  }`}
>
  ...
  Auto-Assign
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg transition ml-4"
                >
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <header className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Calendar className="w-8 h-8" />
            <h1 className="text-3xl font-bold">DutyDesk</h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/*{timeRestrictions.length > 0 && availablePrioritySlots > 0 && pickedPriorityCount < minSlotsRequired && (
          <div className="mb-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg shadow-md">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-yellow-800 font-semibold mb-2 text-lg">⭐ Priority Time Slots Required</h3>
                <p className="text-yellow-700 mb-3">
                  As a <strong>{facultyData?.cadre}</strong>, you must pick priority time slots first before other slots.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div className="bg-yellow-100 p-2 rounded">
                    <span className="text-yellow-800 font-semibold">Priority Time:</span>{' '}
                    <span className="text-yellow-900 font-medium">
                      {timeRestrictions[0].priority_start_time.substring(0, 5)} - {timeRestrictions[0].priority_end_time.substring(0, 5)}
                    </span>
                  </div>
                  <div className="bg-yellow-100 p-2 rounded">
                    <span className="text-yellow-800 font-semibold">Available Slots:</span>{' '}
                    <span className="text-yellow-900 font-medium">{availablePrioritySlots}</span>
                  </div>
                  <div className="bg-yellow-100 p-2 rounded">
                    <span className="text-yellow-800 font-semibold">Your Progress:</span>{' '}
                    <span className="text-yellow-900 font-medium">{pickedPriorityCount}/{minSlotsRequired} picked</span>
                  </div>
                </div>
              </div>
            </div>
...
{isConfirmed && (
  ...
  (selectedExamType &&
    ...
    className="mt-3 w-full bg-red-500 hover:bg-red-600 disabled:bg-gray-400 text-white text-xs font-semibold py-2 px-2 rounded transition shadow-sm hover:shadow"
  >
                        ...
                        <table className="w-full">
                          <thead className="bg-gray-50">
                            <tr>
                              ...
                              <th className="px-4 py-3 text-left font-semibold text-sm">Code</th>
                              <th className="px-4 py-3 text-left font-semibold text-sm">Exam Type</th>
                              <th className="px-4 py-3 text-center font-semibold text-sm">Free</th>
                              ...
                              return (
                                ...
                                >
                                  <td className="px-4 py-3">
                                    <div className="flex items-center gap-2">
                                      {isPriority && <Star className="text-yellow-500 fill-yellow-500 flex-shrink-0" size={16} />}
                                      <span className="font-semibold text-gray-900 text-sm">{session.course_name}</span>
                                    </div>
                                  </td>
                                  <td className="px-4 py-3 text-sm text-gray-600">{session.course_code}</td>
                                  <td className="px-4 py-3">
                                      ...
                                      return (
                                        <div className="space-y-2">
                                          <button
                                            ...
                                            className={`font-semibold py-2 px-6 rounded-lg transition duration-200 ease-in-out shadow-md text-sm
                                              ${loading ? 'opacity-50 cursor-wait' : ''}
                                              ${
                                                hasConflict
                                                  ? 'bg-red-600 text-white cursor-not-allowed border border-red-700'
                                                  : isFull
                                            ...
                                            title={
                                              hasConflict
                                                ? 'Cannot pick — you already have a duty during this time'
                                                : isFull
                                                ? 'No slots available'
                                                : isPriority
                                                ? 'Priority time slot — pick this first!'
                                                : 'Pick this duty'
                                            }
                                          >
                                            {hasConflict
                                          ...
                                          {hasConflict && conflictInfo?.conflicts?.length > 0 && (
                                            <div className="flex items-start gap-1 text-red-600 text-xs">
                                              ...
                                              <div>
                                                <p>
                                                  {conflictInfo.conflicts[0].courseCode} (
                                                  {conflictInfo.conflicts[0].startTime}–{conflictInfo.conflicts[0].endTime})
                                                </p>
                                              </div>
                                            </div>
                                          )}
    ...
    <div className="bg-white rounded-lg max-w-lg w-full p-6 shadow-2xl">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold transition shadow-md hover:shadow-lg flex items-center justify-center gap-2"
        >
          <Star size={18} />
          Find Priority Slots
        </button>
