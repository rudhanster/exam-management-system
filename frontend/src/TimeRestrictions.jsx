...
import { Plus, Edit2, Trash2, Save, X, Award, Clock, AlertCircle, Shield, Calendar, Star, Users } from 'lucide-react';
...
export default function DutyRequirements() {
  ...
  const handleDeleteRequirement = async (id) => {
    ...
    try {
      setLoading(true);
      await axios.delete(`${API_URL}/admin/duty-requirements/${id}`);
      fetchRequirements();
      fetchComplianceStatus();
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-800">Minimum Duty Requirements</h2>
                <button
                  onClick={() => {
                    setShowRequirementForm(true);
                    setEditingRequirement(null);
                    ...
                    <tbody>
                      {complianceStatus.faculty.map((faculty) => (
                        <tr key={faculty.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-center font-semibold">{faculty.min_duties}</td>
                          <td className="px-4 py-3 text-center">
                            <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                              faculty.current_duties === 0 ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'
                            }`}>
        ...
        {activeTab === 'exemptions' && (
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-800">
                  <p className="font-semibold mb-1">About Exemptions:</p>
            ...
            <div className="flex items-center justify-between mb-4">
              <p className="text-gray-600">
                Manage exemptions for <strong>{selectedExamTypeName}</strong>
              </p>
              <button
                onClick={() => {
            ...
            {showExemptionForm && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <h4 className="font-semibold text-gray-800 mb-3">Grant Exemption</h4>
